...
public class HttpConfig {
    ...
    public HttpConfig json(String json) {
        ...
        map.put(ParamUtils.ENTITY_STRING, json);
        return this;
    }
    ...
    public HttpConfig files(String[] filePaths, String inputName, boolean forceRemoveContentTypeChraset) {
        ...
        map.put(ParamUtils.ENTITY_MULTIPART, filePaths);
        map.put(ParamUtils.ENTITY_MULTIPART+".name", inputName);
        map.put(ParamUtils.ENTITY_MULTIPART+".rmCharset", forceRemoveContentTypeChraset);
        return this;
    }
